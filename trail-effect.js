...
(function () {
  ...
  function handleTouchEnd() {
    // Reset tracking so the next tap/swipe starts fresh instead of drawing
    // a trail connecting two unrelated touch points.
    lastX = null;
    lastY = null;
  }
  ...
  window.addEventListener('touchstart', handleMove, { capture: true, passive: true });
